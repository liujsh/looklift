  ...
  return (
    <main className="platform-shell" data-navigation-collapsed={navigationCollapsed}>
      ...
      <section className="platform-content" inert={closeDialog ? true : undefined}>
        ...
        {activeTab.kind === "platform" && (activeTab.page === "settings" ? <SettingsPage client={client} /> : activeTab.page === "automation" ? <AutomationPage client={client} /> : activeTab.page === "library" ? <LibraryPage client={client} onOpen={async (path) => {
