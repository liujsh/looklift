...
> 上游文档:[requirements.md](../requirements.md)(定位/路线图)、[design.md](../design.md)(当前架构)。
> 约定:每个迭代一份 spec,放 `docs/specs/`;实现完成后把架构要点回填 design.md,本文件归档不再改。
...
| T3 | 作者真实照片端到端:auto-refine 3 轮内评分单调或净上升 |
