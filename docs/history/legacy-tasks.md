...
> 路线图与验收标准见 [产品需求](../product/requirements.md)。这里只保留旧迭代任务和历史记录。

## v0.5(下一迭代):供应商 + 库

> 详细设计与验收:[v0.5](../versions/v0.5/)(requirements.md / design.md / tasks.md)
...
> 详细设计:[v0.4](../versions/v0.4/)(requirements.md / design.md / tasks.md);要点已回填 [architecture.md](../product/architecture.md) §16-19。
...
- [ ] **人工验收(9 项)全部待作者**:视觉核对/两种模式的拖拽体验/强度滑杆手感/首次配置
  ...
  [v0.4/tasks.md](../versions/v0.4/tasks.md) 「人工验收」一节
...
> 详细设计:[v0.3/spec.md](../versions/v0.3/spec.md);要点已回填 [architecture.md](../product/architecture.md) §10-15。
