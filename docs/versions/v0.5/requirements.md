...
> 上游文档:[产品需求](../../product/requirements.md)(定位/路线图)、[当前架构](../../product/architecture.md)、
> [v0.3 spec](../v0.3/spec.md)(provider 抽象、Block 约定、`_extract_json`+`_normalize` 容错路径,本迭代直接复用)。
